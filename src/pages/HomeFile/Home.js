  ...
  return (
    <div>
      <div className={styles.HomePage}>
        ...
        <button className={styles.click1}></button>
        <p>
          2011: Teacher of French song at the Instituto Saint-Louis des
          Français. Rome .
        </p>
        <p>2012: Two videos and music for the "Infinite Museum".</p>
        <button className={styles.click2}></button>
        <p>2023: Video and music for the association "Ciel'in Città".</p>
        <button className={styles.click3}></button>
